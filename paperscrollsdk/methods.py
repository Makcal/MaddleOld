...
class PaperScrollMethods:
    ...
    def getLink(self, amount, free_amount=False):
        return 'https://vk.com/app7420483#m{}_{}_{}_{}'.format(
    ...
    def createTransfer(self, peer_id, amount, object_type="balance", object_type_id=0) -> dict:
        """
